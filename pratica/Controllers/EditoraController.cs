...
namespace pratica.Controllers
{
    public class EditoraController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Email")] Editora editora)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Email")] Editora editora)
        {
            if (id != editora.Id)
            {
                return NotFound();
